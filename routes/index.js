...
router.get('/api/classroom/:id', classroomController.getByPk);
...
router.get('/api/student/:id', studentController.getByPk);
...
router.get('/api/lecturer/:id', lecturerController.getByPk);
...
router.get('/api/course/:id', courseController.getByPk);
